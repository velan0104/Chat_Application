...
import { GET_CHANNEL_MESSAGES_ROUTE, GET_MESSAGES, HOST } from '@/utils/constants';
...
const MessageContainer = () => {
  ...
  const { selectedChatType, selectedChatData, userInfo, selectChatMessages, setSelectedChatMessage, setIsDownloading, setFileDownloadProgress } = useAppStore();
